! function(a, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("eva", [], t) : "object" == typeof exports ? exports.eva = t() : a.eva = t() }("undefined" != typeof self ? self : this, function() {
    return function(e) { var h = {};

        function r(a) { if (h[a]) return h[a].exports; var t = h[a] = { i: a, l: !1, exports: {} }; return e[a].call(t.exports, t, t.exports, r), t.l = !0, t.exports } return r.m = e, r.c = h, r.d = function(a, t, e) { r.o(a, t) || Object.defineProperty(a, t, { enumerable: !0, get: e }) }, r.r = function(a) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(a, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(a, "__esModule", { value: !0 }) }, r.t = function(t, a) { if (1 & a && (t = r(t)), 8 & a) return t; if (4 & a && "object" == typeof t && t && t.__esModule) return t; var e = Object.create(null); if (r.r(e), Object.defineProperty(e, "default", { enumerable: !0, value: t }), 2 & a && "string" != typeof t)
                for (var h in t) r.d(e, h, function(a) { return t[a] }.bind(null, h)); return e }, r.n = function(a) { var t = a && a.__esModule ? function() { return a.default } : function() { return a }; return r.d(t, "a", t), t }, r.o = function(a, t) { return Object.prototype.hasOwnProperty.call(a, t) }, r.p = "", r(r.s = "./package/src/index.js") }({
        ...
        /*! no static exports found */
            ...
            */
            ! function() { "use strict"; var a = function() {
                    ...
                    function i(a, t) { for (var e = t.length, h = 0; h < e; ++h) r(a, t[h]) }
                    g.prototype = Object.create(null); var h = {}.hasOwnProperty; var d = /\s+/;

                    function r(a, t) { if (t) { var e = typeof t; "string" === e ? function(a, t) { for (var e = t.split(d), h = e.length, r = 0; r < h; ++r) a[e[r]] = !0 }(a, t) : Array.isArray(t) ? i(a, t) : "object" === e ? function(a, t) { for (var e in t) h.call(t, e) && (a[e] = !!t[e]) }(a, t) : "number" === e && (a[t] = !0) } } return function() { for (var a = arguments.length, t = Array(a), e = 0; e < a; e++) t[e] = arguments[e]; var h = new g;
                        i(h, t); var r = []; for (var d in h) h[d] && r.push(d); return r.join(" ") } }();
                void 0 !== t && t.exports ? (a.default = a, t.exports = a) : void 0 === (h = function() { return a }.apply(e, [])) || (t.exports = h) }()
        },
        ...
        /*!*************************************************!*\
          ...
          \*************************************************/
        /*! no static exports found */
            function(a, t) { a.exports = function(e) { var g = []; return g.toString = function() { return this.map(function(a) { var t = function(a, t) { var e = a[1] || "",
                                h = a[3]; if (!h) return e; if (t && "function" == typeof btoa) { var r = (g = h, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(g)))) + " */"),
                                    d = h.sources.map(function(a) { return "/*# sourceURL=" + h.sourceRoot + a + " */" }); return [e].concat(d).concat([r]).join("\n") } var g; return [e].join("\n") }(a, e); return a[2] ? "@media " + a[2] + "{" + t + "}" : t }).join("") }, g.i = function(a, t) { "string" == typeof a && (a = [
                        [null, a, ""]
                    ]); for (var e = {}, h = 0; h < this.length; h++) { var r = this[h][0]; "number" == typeof r && (e[r] = !0) } for (h = 0; h < a.length; h++) { var d = a[h]; "number" == typeof d[0] && e[d[0]] || (t && !d[2] ? d[2] = t : t && (d[2] = "(" + d[2] + ") and (" + t + ")"), g.push(d)) } }, g } },
        ...
        /*! no static exports found */
            ...
            var A = {};
            a.exports = function(a, t) { for (var e, h = void 0 === t ? {} : t, r = h.replace, d = void 0 !== r && r, g = h.prepend, i = void 0 !== g && g, n = h.prefix, o = void 0 === n ? "s" : n, l = [], c = 0; c < a.length; c++) { var p = a[c],
                        m = p[0],
                        y = p[1],
                        z = p[2],
                        M = p[3],
                        v = "" + o + m + "-" + c; if (l.push(v), !A[v] || d) { A[v] = 1; var L = document.getElementById(v),
                            s = !1;
                        L || (s = !0, (L = document.createElement("style")).setAttribute("type", "text/css"), L.id = v, z && L.setAttribute("media", z)); var w = y;
                        M && "function" == typeof btoa && (w += "\n/*# sourceMappingURL=data:application/json;base64," + (e = JSON.stringify(M), btoa(encodeURIComponent(e).replace(/%([0-9A-F]{2})/g, function(a, t) { return String.fromCharCode("0x" + t) }))) + "*/", w += "\n/*# sourceURL=" + M.file + "?" + v + "*/"), "textContent" in L ? L.textContent = w : L.styleSheet.cssText = w, s && (i ? document.head.insertBefore(L, document.head.childNodes[0]) : document.head.appendChild(L)) } else A[v]++ } return function(a) { a.forEach(function(a) { if (--A[a] <= 0) { var t = document.getElementById(a);
                            t && t.parentNode.removeChild(t) } }) }.bind(null, l) } },
        ...
        /*! exports provided: default */
            ...
            function o(a, t) { if (null == a) return {}; var e, h, r = function(a, t) { if (null == a) return {}; var e, h, r = {},
                        d = Object.keys(a); for (h = 0; h < d.length; h++) e = d[h], 0 <= t.indexOf(e) || (r[e] = a[e]); return r }(a, t); if (Object.getOwnPropertySymbols) { var d = Object.getOwnPropertySymbols(a); for (h = 0; h < d.length; h++) e = d[h], 0 <= t.indexOf(e) || Object.prototype.propertyIsEnumerable.call(a, e) && (r[e] = a[e]) } return r }

            function l(t) { for (var a = 1; a < arguments.length; a++) { var e = null != arguments[a] ? arguments[a] : {},
                        h = Object.keys(e); "function" == typeof Object.getOwnPropertySymbols && (h = h.concat(Object.getOwnPropertySymbols(e).filter(function(a) { return Object.getOwnPropertyDescriptor(e, a).enumerable }))), h.forEach(function(a) { d(t, a, e[a]) }) } return t }

            function d(a, t, e) { return t in a ? Object.defineProperty(a, t, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : a[t] = e, a }

            function g(a, t) { for (var e = 0; e < t.length; e++) { var h = t[e];
             ...
             */
            var c = { hover: !0 },
                p = function(a) { return "string" == typeof a || a instanceof String },
                i = function() {
                    function e(a, t) {! function(a, t) { if (!(a instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, e), this.name = a, this.contents = t, this.attrs = l({}, r, { class: "eva eva-".concat(a) }) } var a, t, h; return a = e, (t = [{ key: "toSvg", value: function() { var t, a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                                e = a.animation,
                                h = o(a, ["animation"]),
                                r = function(a) { if (!a) return null;
                                    a.hover && (a.hover = p(a.hover) ? JSON.parse(a.hover) : a.hover); var t = l({}, c, a),
                                        e = t.hover ? "eva-icon-hover-".concat(t.type) : "eva-icon-".concat(t.type); return t.class = n()({ "eva-animation": !0, "eva-infinite": p(a.infinite) ? JSON.parse(a.infinite) : a.infinite }, e), t }(e),
                                d = r ? r.class : "",
                                g = l({}, this.attrs, h, { class: n()(this.attrs.class, a.class, d) }),
                                i = "<svg ".concat((t = g, Object.keys(t).map(function(a) { return "".concat(a, '="').concat(t[a], '"') }).join(" ")), ">").concat(this.contents, "</svg>"); return r && r.hover ? '<i class="eva-hover">'.concat(i, "</i>") : i } }, { key: "toString", value: function() { return this.contents } }]) && g(a.prototype, t), h && g(a, h), e }();
            t.default = i
        },
        ...
        /*! exports provided: default */
            function(a, t, e) { "use strict";
            e.r(t); var h = e( /*! ./icon */ "./package/src/icon.js"),
        ...
        /*! exports provided: icons, replace */
            ...
            e.d(t, "icons", function() { return h.default });
            var r = e( /*! ./replace */ "./package/src/replace.js");
            e.d(t, "replace", function() { return r.default });
        ...
        /*! exports provided: default */
            function(a, t, e) { "use strict";
            e.r(t); var h = e( /*! classnames/dedupe */ "./node_modules/classnames/dedupe.js"),
                c = e.n(h),
                p = e( /*! ./icons */ "./package/src/icons.js");

            function m(t) { for (var a = 1; a < arguments.length; a++) { var e = null != arguments[a] ? arguments[a] : {},
                        h = Object.keys(e); "function" == typeof Object.getOwnPropertySymbols && (h = h.concat(Object.getOwnPropertySymbols(e).filter(function(a) { return Object.getOwnPropertyDescriptor(e, a).enumerable }))), h.forEach(function(a) { y(t, a, e[a]) }) } return t }

            function y(a, t, e) { return t in a ? Object.defineProperty(a, t, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : a[t] = e, a }

            function z(a, t) { if (null == a) return {}; var e, h, r = function(a, t) { if (null == a) return {}; var e, h, r = {},
                            d = Object.keys(a); for (h = 0; h < d.length; h++) e = d[h], 0 <= t.indexOf(e) || (r[e] = a[e]); return r }
                    /**
                     * @license
                     * Copyright Akveo. All Rights Reserved.
                     * Licensed under the MIT License. See License.txt in the project root for license information.
                     */
                    (a, t); if (Object.getOwnPropertySymbols) { var d = Object.getOwnPropertySymbols(a); for (h = 0; h < d.length; h++) e = d[h], 0 <= t.indexOf(e) || Object.prototype.propertyIsEnumerable.call(a, e) && (r[e] = a[e]) } return r } var M = { "data-eva-animation": "type", "data-eva-hover": "hover", "data-eva-infinite": "infinite" },
                v = { "data-eva": "name", "data-eva-width": "width", "data-eva-height": "height", "data-eva-fill": "fill" };
            t.default = function() { var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}; if ("undefined" == typeof document) throw new Error("`eva.replace()` only works in a browser environment."); var a = document.querySelectorAll("[data-eva]");
                Array.from(a).forEach(function(a) { return function(a) { var t, e, h, r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                            d = (h = a, Array.from(h.attributes).reduce(function(a, t) { var e; return M[t.name] ? a.animation = m({}, a.animation, y({}, M[t.name], t.value)) : a = m({}, a, v[(e = t).name] ? y({}, v[e.name], e.value) : y({}, e.name, e.value)), a }, {})),
                            g = d.name,
                            i = z(d, ["name"]),
                            n = p.default[g].toSvg(m({}, r, i, { animation: (t = r.animation, e = i.animation, t || e ? m({}, t, e) : null) }, { class: c()(r.class, i.class) })),
                            o = (new DOMParser).parseFromString(n, "text/html"),
                            l = o.querySelector(".eva-hover") || o.querySelector("svg");
                        a.parentNode.replaceChild(l, a) }(a, t) }) } }
    })
});