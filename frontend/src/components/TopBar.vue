<template>
  <header id="page-topbar" class="isvertical-topbar">
      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box">
          <a href="index-2.html" class="logo logo-dark">
            <span class="logo-sm">
              <img src="../assets/images/logo1.png" alt="" height="26" />
            </span>
            <span class="logo-lg">
              <img src="../assets/images/logo1.png" alt="" height="26" />
            </span>
        ...
        <div class="page-title-box align-self-center d-none d-md-block">
          <h4 class="page-title mb-0">Welcome back Mihigo prince</h4>
        </div>
        <!-- end page title -->
      </div>
          ...
          >
            ...
            <div class="p-2 border-top d-grid">
              <a
                ...
                ><i class="uil-arrow-circle-right me-1"></i> <span>View More..</span></a
              >
            </div>
          </div>
        </div>
    ...
    <router-link to="/ComingSoon" class="dropdown-item d-flex align-items-center">
    ...
    <router-link to="/auth-lock-screen" class="dropdown-item">
      <i class="mdi mdi-lock text-muted font-size-16 align-middle me-2"></i>
